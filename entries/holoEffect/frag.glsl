...
// outputColor=diffuseBase;
// outputColor=vec4(vec3(n1),1.);
// outputColor=vec4(vec3(dir),1.);
// outputColor=hologramColor;
// outputColor=vec4(combinedColor,1.);
// outputColor=vec4(bgColor,1.);
// outputColor=vec4(lumiColor,1.);
// outputColor=vec4(col,1.);
}