...
var POSTPROCESSING = (() => {
  ...
  function getTextureDecoding(texture, isWebGL2) {
    ...
    if (texture !== null) {
      ...
      const sRGB8Alpha8 =
        ...
        revision >= 133 &&
        revision !== 135 &&
        texture.format === import_three3.RGBAFormat &&
        texture.type === import_three3.UnsignedByteType &&
        texture.encoding === import_three3.sRGBEncoding;
      if (!sRGB8Alpha8) {
  ...
  var BoxBlurMaterial = class extends import_three4.ShaderMaterial {
    ...
    set kernelSize(value) {
      ...
      this.defines.KERNEL_SIZE_SQ_HALF = Math.floor(
        __pow(value, 2) / 2
      ).toFixed(0);
  ...
  var CircleOfConfusionMaterial = class extends import_three5.ShaderMaterial {
    ...
    set worldFocusDistance(value) {
      this.focusDistance = viewZToOrthographicDepth(
        -value,
        this.near,
        this.far
      );
    ...
    constructor() {
      super({
        ...
        uniforms: {
          ...
          cameraNearFar: new import_three11.Uniform(
            new import_three11.Vector2(1, 1)
          ),
        },
  ...
  var EdgeDetectionMaterial = class extends import_three13.ShaderMaterial {
    constructor(
      texelSize = new import_three13.Vector2(),
      mode = EdgeDetectionMode.COLOR
    ) {
      super({
    ...
    setShaderParts(shaderParts) {
      ...
      this.vertexShader = effect_default2
        ...
        .replace(
          ...
          (_e = shaderParts.get(EffectShaderSection.VERTEX_MAIN_SUPPORT)) !=
            null
            ? _e
            : ""
        );
  ...
  var SMAAWeightsMaterial = class extends import_three20.ShaderMaterial {
    constructor(
      texelSize = new import_three20.Vector2(),
      resolution = new import_three20.Vector2()
    ) {
      super({
    ...
    constructor(camera) {
      super({
        ...
        uniforms: {
          ...
          inverseProjectionMatrix: new import_three21.Uniform(
            new import_three21.Matrix4()
          ),
          projectionMatrix: new import_three21.Uniform(
            new import_three21.Matrix4()
          ),
          texelSize: new import_three21.Uniform(new import_three21.Vector2()),
          cameraNearFar: new import_three21.Uniform(
            new import_three21.Vector2()
          ),
          distanceCutoff: new import_three21.Uniform(
            new import_three21.Vector2()
          ),
          proximityCutoff: new import_three21.Uniform(
            new import_three21.Vector2()
          ),
  ...
  var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
    constructor({
      ...
      this.uniforms.rotation = new import_three22.Uniform(
        new import_three22.Vector2()
      );
      this.uniforms.maskParams = new import_three22.Uniform(
        new import_three22.Vector4()
      );
      this._offset = offset;
    ...
    if (geometry === null) {
      ...
      if (geometry.setAttribute !== void 0) {
        geometry.setAttribute(
          "position",
          new import_three24.BufferAttribute(vertices, 3)
        );
  ...
  var Pass = class {
    constructor(
      name = "Pass",
      scene = new import_three24.Scene(),
      camera = dummyCamera
    ) {
      this.name = name;
      this.renderer = null;
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three24.BasicDepthPacking
    ) {}
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        ...
        const isDisposable =
          property instanceof import_three24.WebGLRenderTarget ||
          property instanceof import_three24.Material ||
          property instanceof import_three24.Texture ||
  ...
  var BoxBlurPass = class extends Pass {
    constructor({
      ...
      this.renderTargetA = new import_three27.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
      this.renderTargetA.texture.name = "Blur.Target.A";
      this.renderTargetB = new import_three27.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three27.BasicDepthPacking
    ) {
  ...
  var DepthPass = class extends Pass {
    constructor(
      ...
      this.renderPass = new RenderPass(
        scene,
        camera,
        new import_three31.MeshDepthMaterial({
  ...
  var DepthDownsamplingPass = class extends Pass {
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three32.BasicDepthPacking
    ) {
  ...
  var DepthCopyPass = class extends Pass {
    constructor({ depthPacking = import_three33.RGBADepthPacking } = {}) {
      ...
      this.renderTarget = new import_three33.WebGLRenderTarget(1, 1, {
        type:
          depthPacking === import_three33.RGBADepthPacking
            ? import_three33.UnsignedByteType
            : import_three33.FloatType,
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three33.BasicDepthPacking
    ) {
      this.fullscreenMaterial.depthBuffer = depthTexture;
  ...
  var DepthPickingPass = class extends DepthCopyPass {
    constructor({
      depthPacking = import_three34.RGBADepthPacking,
...
`;
      ...
      if (mainImageExists) {
        if (
          ...
          fragmentMainImage +=
            effect.inputColorSpace === import_three35.sRGBEncoding
...
`;
  ...
  var EffectPass = class extends Pass {
    ...
    updateMaterial() {
      ...
      let fragmentHead = data.shaderParts.get(
        EffectShaderSection.FRAGMENT_HEAD
      );
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three35.BasicDepthPacking
    ) {
      this.fullscreenMaterial.depthBuffer = depthTexture;
      this.fullscreenMaterial.depthPacking = depthPacking;
      for (const effect of this.effects) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (
        ...
        frameBufferType !== import_three35.UnsignedByteType
      ) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
  ...
  var GaussianBlurPass = class extends Pass {
    constructor({
      ...
      this.renderTargetA = new import_three36.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
      this.renderTargetA.texture.name = "Blur.Target.A";
  ...
  var KawaseBlurPass = class extends Pass {
    constructor({
      ...
      this.renderTargetA = new import_three37.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
      this.renderTargetA.texture.name = "Blur.Target.A";
      this.renderTargetB = this.renderTargetA.clone();
  ...
  var LuminancePass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (
        frameBufferType !== void 0 &&
        frameBufferType !== import_three38.UnsignedByteType
      ) {
        this.renderTarget.texture.type = frameBufferType;
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
  ...
  var NormalPass = class extends Pass {
    constructor(
      ...
      this.renderPass = new RenderPass(
        scene,
        camera,
        new import_three40.MeshNormalMaterial()
      );
      const renderPass = this.renderPass;
      renderPass.ignoreBackground = true;
      renderPass.skipShadowMapUpdate = true;
  ...
  var ShaderPass = class extends Pass {
    ...
    initialize(renderer, alpha, frameBufferType) {
      if (
        frameBufferType !== void 0 &&
        frameBufferType !== import_three41.UnsignedByteType
      ) {
        this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
      }
    }
  ...
  var EffectComposer = class {
    ...
    setRenderer(renderer) {
      ...
      if (renderer !== null) {
        ...
        if (
          frameBufferType === import_three42.UnsignedByteType &&
          renderer.outputEncoding === import_three42.sRGBEncoding
        ) {
    ...
    createDepthTexture() {
      const depthTexture = (this.depthTexture =
        new import_three42.DepthTexture());
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      ...
      const size =
        renderer === null
          ? new import_three42.Vector2()
          : renderer.getDrawingBufferSize(new import_three42.Vector2());
      const options = {
      ...
      if (multisampling > 0) {
        renderTarget =
          Number(import_three42.REVISION.replace(/\D+/g, "")) < 138
            ? new import_three42.WebGLMultisampleRenderTarget(
                size.width,
                size.height,
                options
              )
            : new import_three42.WebGLRenderTarget(
                size.width,
                size.height,
                options
              );
        ...
        renderTarget = new import_three42.WebGLRenderTarget(
          size.width,
          size.height,
          options
        );
      ...
      if (
        type === import_three42.UnsignedByteType &&
        renderer !== null &&
        renderer.outputEncoding === import_three42.sRGBEncoding
      ) {
  ...
  var Effect = class extends import_three45.EventDispatcher {
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three45.BasicDepthPacking
    ) {}
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        const isDisposable =
          property instanceof import_three45.WebGLRenderTarget ||
          property instanceof import_three45.Material ||
          property instanceof import_three45.Texture ||
          property instanceof Pass;
        if (isDisposable) {
          this[key].dispose();
        }
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      this.renderTarget = new import_three46.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(
      ...
      this.camera = camera;
      this.renderTarget = new import_three51.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three51.BasicDepthPacking
    ) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(
        renderer,
        alpha,
        import_three51.UnsignedByteType
      );
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
        ...
        if (renderer.outputEncoding === import_three51.sRGBEncoding) {
          ...
          this.renderTargetMasked.texture.encoding =
            import_three51.sRGBEncoding;
        }
      }
    }
  };
  ...
  var NoiseTexture = class extends import_three54.DataTexture {
    constructor(
      width,
      height,
      format = import_three54.LuminanceFormat,
      type = import_three54.UnsignedByteType
    ) {
      super(
        getNoise(width * height, format, type),
        width,
        height,
        format,
        type
    ...
    constructor({
      ...
      super("GlitchEffect", glitch_default, {
        uniforms: /* @__PURE__ */ new Map([
          ...
          [
            "distortion",
            new import_three55.Uniform(new import_three55.Vector2()),
          ],
        ]),
      });
  ...
  var GodRaysEffect = class extends Effect {
    constructor(
      ...
      this.renderTargetA = new import_three56.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
      ...
      this.renderPassLight.clearPass.overrideClearColor =
        new import_three56.Color(0);
      ...
      this.godRaysPass = new ShaderPass(
        new GodRaysMaterial(this.screenPosition)
      );
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three56.BasicDepthPacking
    ) {
  ...
  var LUT1DEffect = class extends Effect {
    ...
    set lut(value) {
      ...
      if (
        value !== null &&
        (value.type === import_three59.FloatType ||
          value.type === import_three59.HalfFloatType)
      ) {
  ...
  var LookupTexture = class extends import_three60.DataTexture3D {
    ...
    applyLUT(lut) {
      ...
      if (size0 !== size1) {
        ...
        lut.type !== import_three60.FloatType ||
        this.type !== import_three60.FloatType
      ) {
        console.error("Both LUTs must be FloatType textures");
      } else if (
        lut.format !== import_three60.RGBAFormat ||
        this.format !== import_three60.RGBAFormat
      ) {
    ...
    toDataTexture() {
      ...
      const texture = new import_three60.DataTexture(
        this.image.data,
        width,
        height
      );
  ...
  var SMAASearchImageData = class {
    static generate() {
      ...
      const croppedData = new Uint8ClampedArray(
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (
            value.type === import_three62.FloatType ||
            value.type === import_three62.HalfFloatType
          ) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (
          ...
          lut instanceof import_three62.DataTexture3D
        ) {
  ...
  var OutlineEffect = class extends Effect {
    constructor(
      ...
      super("OutlineEffect", outline_default3, {
        uniforms: /* @__PURE__ */ new Map([
          ...
          [
            "visibleEdgeColor",
            new import_three63.Uniform(
              new import_three63.Color(visibleEdgeColor)
            ),
          ],
          [
            "hiddenEdgeColor",
            new import_three63.Uniform(
              new import_three63.Color(hiddenEdgeColor)
            ),
          ],
      ...
      this.renderTargetOutline = new import_three63.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(
        renderer,
        alpha,
        import_three63.UnsignedByteType
      );
      if (frameBufferType !== void 0) {
    ...
    constructor({
      ...
      super("RealisticBokehEffect", realistic_bokeh_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          [
            "luminanceThreshold",
            new import_three65.Uniform(luminanceThreshold),
          ],
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new import_three65.Vector4(
            0.2,
            1,
            0.2,
            2
  ...
  var ShockWaveEffect = class extends Effect {
    constructor(
      camera,
      position = new import_three67.Vector3(),
      ...
      super("ShockWaveEffect", shock_wave_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          [
            "center",
            new import_three67.Uniform(new import_three67.Vector2(0.5, 0.5)),
          ],
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      this.renderTargetMasked = new import_three68.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    set inverted(value) {
      ...
      this.depthMaskMaterial.depthMode = value
        ? import_three68.NotEqualDepth
        : import_three68.EqualDepth;
    }
    isInverted() {
      return this.inverted;
    }
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three68.BasicDepthPacking
    ) {
    ...
    constructor({ blendFunction, intensity = 1 } = {}) {
      super("SepiaEffect", sepia_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          [
            "weightsR",
            new import_three69.Uniform(
              new import_three69.Vector3(0.393, 0.769, 0.189)
            ),
          ],
          [
            "weightsG",
            new import_three69.Uniform(
              new import_three69.Vector3(0.349, 0.686, 0.168)
            ),
          ],
          [
            "weightsB",
            new import_three69.Uniform(
              new import_three69.Vector3(0.272, 0.534, 0.131)
            ),
          ],
        ]),
      });
  ...
  var SMAAEffect = class extends Effect {
    constructor({
      ...
      this.renderTargetEdges = new import_three70.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three70.BasicDepthPacking
    ) {
  ...
  var SSAOEffect = class extends Effect {
    constructor(
      ...
      super("SSAOEffect", ssao_default3, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          [
            "luminanceInfluence",
            new import_three71.Uniform(luminanceInfluence),
          ],
      ...
      this.renderTarget = new import_three71.WebGLRenderTarget(1, 1, {
        depthBuffer: false,
      });
    ...
    setDepthTexture(
      depthTexture,
      depthPacking = import_three71.BasicDepthPacking
    ) {
    ...
    initialize(renderer, alpha, frameBufferType) {
      try {
        ...
        if (normalDepthBuffer === null) {
          this.depthDownsamplingPass.initialize(
            renderer,
            alpha,
            frameBufferType
          );
    ...
    constructor({
      ...
      super("TiltShiftEffect", tilt_shift_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          [
            "rotation",
            new import_three73.Uniform(new import_three73.Vector2()),
          ],
          [
            "maskParams",
            new import_three73.Uniform(new import_three73.Vector2()),
...
class ReflectionsMaterial extends three.ShaderMaterial {
  constructor() {
    super({
      ...
      fragmentShader: fragmentShader$1.replace(
        "#include <helperFunctions>",
        helperFunctions
      ),
